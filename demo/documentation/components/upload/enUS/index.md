...
|on-remove|`(file: UploadFile, fileList: Array<UploadFile>) => any`|`() => {}`|The callback of file removal.|
|on-finish|`(file: UploadFile, fileList: Array<UploadFile>) => any`|`() => {}`|The callback of file upload finish. You can modify the UploadFile.|

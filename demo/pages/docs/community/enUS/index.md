...
| [Vue Simple Template](https://github.com/gitboyzcf/vue3-simple-template) | A simple universal starter template based on Vue 3.5 + Vite 8 + Naive UI + TypeScript + Pinia + Vue Router + Tailwind CSS 4 + Pnpm. |

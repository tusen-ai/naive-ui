...
| [Vue Simple Template](https://github.com/gitboyzcf/vue3-simple-template) | 一款基于 Vue 3.5 + Vite 8 + Naive UI + TypeScript + Pinia + Vue Router + Tailwind CSS 4 + Pnpm 的简洁通用模板 |

...
- Fix `n-tree`'s Where clicking the expand icon triggers two events during asynchronous loading, closes [#5229](https://github.com/tusen-ai/naive-ui/issues/5229)

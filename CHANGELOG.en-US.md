...
- Fix `n-data-table` horizontal scrollbar disappearing when data is empty with `flex-height` or `max-height` and `scroll-x` set, closes [#5052](https://github.com/tusen-ai/naive-ui/issues/5052).

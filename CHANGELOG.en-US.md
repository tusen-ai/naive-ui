...
- `n-notification` injection methods now support a `placement` option for positioning individual notifications, closes [#8156](https://github.com/tusen-ai/naive-ui/issues/8156).

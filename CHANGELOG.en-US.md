...
- Fix `n-dynamic-tags` component when delete tag, the focus is focused on the location of the deleted label, closes [#4555](https://github.com/tusen-ai/naive-ui/issues/4555).

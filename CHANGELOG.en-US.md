...
- `n-select` adds `update-on-same-value` prop to control whether to trigger `update:value` event when selecting the same value, closes [#4326](https://github.com/tusen-ai/naive-ui/issues/4326)

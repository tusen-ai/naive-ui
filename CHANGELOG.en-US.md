...
- Fix `n-select` repeatedly selects the selected item in `single`, the `onUpdate:value` will not be triggered repeatedly, closes [#4326](https://github.com/tusen-ai/naive-ui/issues/4326).

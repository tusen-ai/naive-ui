...
- `n-data-table` adds `toggleAllSelection`, `clearSelection`, `toggleRowSelection`, `toggleRowExpansion`, `getSelectionRows`, `setCurrentRow` instance methods, closes [#3704](https://github.com/tusen-ai/naive-ui/issues/3704).

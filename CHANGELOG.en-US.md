...
- `n-carousel` add `active-index` prop.
- `n-carousel` add `show-arrow` prop.
- `n-carousel` add `dot-style` prop, closes [#1931](https://github.com/TuSimple/naive-ui/issues/1931).
...
- `n-carousel` add `speed` prop, closes [#1159](https://github.com/TuSimple/naive-ui/issues/1159).

...
- Fix `n-image-group` registration guard using the wrong map key for duplicate image registration, closes [#8158](https://github.com/tusen-ai/naive-ui/issues/8158).

...
- 修复 `n-button` 类型为 `secondary` 时 `n-config-provider` 设置的 `colorFocus`、`textColorFocus` 和 `borderFocus` 不生效的问题，关闭 [#8145](https://github.com/tusen-ai/naive-ui/issues/8145)

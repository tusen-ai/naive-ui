...
| close-on-esc | `boolean` | `true` | 是否在摁下 Esc 键的时候关闭 Modal | NEXT_VERSION |
...
| trap-focus | `boolean` | `true` | 是否将焦点锁定在 Modal 内部 | NEXT_VERSION |
...
| on-esc | `() => void` | `undefined` | 焦点在 Modal 内部时按下 Esc 键的回调 | NEXT_VERSION |

...
export default defineComponent({
  ...
  render () {
    ...
    return (
      <div
        class={`${clsPrefix}-gradient-picker-pallete`}
        onMousedown={this.handleMouseDown}
        ref="palleteRef"
      >
        <div
          class={`${clsPrefix}-gradient-picker-pallete__layer`}
          style={{
            backgroundImage: `linear-gradient(90deg, white, hsl(${this.displayedHue}, 100%, 50%))`
          }}
        />
        <div
          class={`${clsPrefix}-gradient-picker-pallete__layer ${clsPrefix}-gradient-picker-pallete__layer--shadowed`}
          style={{
            backgroundImage:

...
| on-before-upadte | `(options: { file: UploadFile, fileList: Array<UploadFile> }) => (Promise<boolean \| void> \| boolean \| void)` | `true` | 文件上传之前的回调，返回 `false` , `Promise resolve false` , `Promise rejected` 会取消本次上传 |
### UploadFile Type

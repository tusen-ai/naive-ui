...
| always-show-actions | `boolean` | `false` | Always show the action buttons (remove, download, retry, preview) on each file item. When `false`, they only appear on hover. | 2.45.0 |

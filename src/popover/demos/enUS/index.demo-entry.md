...
| overlap | `boolean` | `false` | Override trigger element. |
...
| on-update:show | `(value: boolean) => void` | `undefined` | The callback is fired when the show value change. |
...
| header  | `()`       | The header content of popover.                  |

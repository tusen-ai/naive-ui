...
| add-tab-class | `string` | `undefined` | Class of the add tab. | NEXT_VERSION |
| add-tab-style | `string \| object` | `undefined` | Style of the add tab. | NEXT_VERSION |
...
| tab-class | `string` | `undefined` | Class of the tab. | NEXT_VERSION |

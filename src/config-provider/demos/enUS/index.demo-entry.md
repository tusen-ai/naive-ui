...
| breakpoints | `{ [k: string]: number }` | `{ xs: <576px, s: ≥640px, m: ≥1024px, l: ≥1280px, xl: ≥1536px, xxl: ≥1920px }` | Responsive breakpoints, it will be used in `n-grid`. The prop is not responsive, you need to set it on its first mount. |  |

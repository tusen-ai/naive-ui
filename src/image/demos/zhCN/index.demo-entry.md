...
| render-toolbar | `(nodes: { prev: VNode, next: VNode, rotateLeft: VNode, rotateRight: VNode, originalSize: VNode, zoomOut: VNode, zoomIn: VNode, download: VNode, close: VNode }) => VNodeChild` | `undefined` | 工具栏的渲染函数 | `NEXT_VERSION` |

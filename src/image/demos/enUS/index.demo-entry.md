...
| render-toolbar | `(props: { originalNodes: { prev: VNode, next: VNode, rotateLeft: VNode, rotateRight: VNode, resizeToOriginalSize: VNode, zoomOut: VNode, zoomIn: VNode, download: VNode, close: VNode } }) => VNodeChild` | `undefined` | Toolbar rendering function. | `NEXT_VERSION` |

...
| keep-drag-offset | `boolean` | `false` | Whether to keep the dragged offset of the previewed image after the mouse is released. By default the image snaps back to center (or to the viewport bounds when larger than the viewport). | 2.45.0 |

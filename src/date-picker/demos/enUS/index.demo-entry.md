...
| shortcuts | `Record<string, number \| ((date?: Value \| null) => number)> \| Record<string, [number, number] \| ((date?: Value \| null) => [number, number])>` | `undefined` | Shortcut button customizations. |

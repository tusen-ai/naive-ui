...
| input-props | `HTMLInputAttributes` | `undefined` | 组件内部 input 元素的属性，[在这里查看原生属性](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input)。注意：`input-props` 不会覆盖内部 input 元素的已经存在的属性（除了 `type`） | NEXT_VERSION |

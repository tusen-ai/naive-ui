...
| children-field | `string` | `'label'` | 选项组 children 的字段名 | NEXT_VERSION |
...
| label-field | `string` | `'label'` | 选项 label 的字段名 | NEXT_VERSION |
...
| value-field | `string` | `'value'` | 选项 value 的字段名 | NEXT_VERSION |

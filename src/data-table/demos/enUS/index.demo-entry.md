...
| on-update:sorter | type Option = { columnKey: string \| number, sorter: 'default' \| function \| boolean, order: 'ascend' \| 'descend' \| false } <br/> `(options: Option \| Option[] \| null) => void` | `undefined` | If the change column is sorted by multiple columns, will return `Option[] \| null`, otherwise return `Option \| null`. |

...
| render-expand-icon | `({ expanded, rowKey, rowData }: { expanded: boolean, rowKey: string \| number, rowData: object  }) => VNodeChild` | `undefined` | Render function of expand icon. | 2.32.2, `expanded`: 2.34.4 |

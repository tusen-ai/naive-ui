...
| on-update:checked-row-keys | `(keys: Array<string \| number>, rows: object[], row: object) => void` | `undefined` | The callback function triggered when the checked-row-keys value changes. | `rows` 2.30.5 |

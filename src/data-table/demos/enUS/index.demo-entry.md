...
| filter-icon-popover-props | `PopoverProps` | `{ trigger: click, placement: bottom }` | Filter the Popover attribute of the button |
| , See [Popover props](popover#Popover-Props) | NEXT_VERSION |

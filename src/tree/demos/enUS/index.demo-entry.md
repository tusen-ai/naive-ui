...
| on-update:checked-keys | `(keys: Array<string \| number>, option: Array<TreeOption \| null>, info: { action: 'check' \| 'uncheck', option: TreeOption })) => void` | `undefined` | Callback function when node checked options change. |  |

...
| on-update:checked-keys | `(keys: Array<string \| number>, option: Array<TreeOption \| null>, info: { action: 'check' \| 'uncheck', option: TreeOption }) => void` | `undefined` | 节点勾选项发生变化时的回调函数 |  |
